          ...
          <div className={styles.content}>
            <div className={styles.moodStrip} aria-hidden="true">
              {MOOD_PALETTE.map((c, i) => (
                <span
                  ...
                  style={{ background: c, animationDelay: `${i * 80}ms` }}
                />
              ))}
            </div>

            <h2 className={styles.title}>
              {t.finalCta.titleBefore} <em>{t.finalCta.titleEm}</em> {t.finalCta.titleAfter}
            </h2>
            ...
            <div className={styles.qrSection}>
              <div className={styles.qrItem}>
                ...
                <span className={styles.qrLabel}>{t.finalCta.qrIphone}</span>
              </div>
              ...
              <div className={styles.qrItem}>
                ...
                <span className={styles.qrLabel}>{t.finalCta.qrAndroid}</span>
              </div>
            </div>
          </div>
        </div>
